...
public class TreeNode<K extends Comparable, V> {
    ...
    void setLeftChildNodeForItem(int itemPosition, Item<K, V> item) throws Exception {
    ...
    void setRightChildNodeForItem(int itemPosition, Item<K, V> item) throws Exception {
